      ...
      <div class="flex-grow flex justify-between">
        ...
        <div class="right w-1/5">
          ...
          <div class="w-full flex justify-between pb-12">
            <img src="~/assets/icons/facebookLogo.png" style="height: 60px;width: 60px; border-radius: 50%;" alt=""
              class="cursor-pointer" @click="openUrl">
            <a href="https://www.linkedin.com/company/shopflex/" target="view_window">
            ...
            <a href="https://www.youtube.com/@shopflex-automizeyouronlin1967" target="view_window">
              <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="30" cy="30" r="30" fill="white" />
                <path
            ...
            <a href="https://twitter.com/ShopFlexApp" target="view_window">
              <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="30" cy="30" r="30" fill="white" />
                <path
...
export default {
  ...
  methods: {
    openUrl() {
      window.open('https://www.facebook.com/groups/shopflex')
    }
  }
}
</script>
